    ...
    case SEARCH_POST:
      {
        ...
        var postTitle = state.mainPosts.filter(function (v) {
          if (v.title.includes(term) || v.nickname.includes(term)) {
            return true;
          }
        });
        console.log(posts);
...
//# sourceMappingURL=index.js.db0c6cd1b970cefebd30.hot-update.js.map