...
var reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case SEARCH_POST:
      {
        var term = action.data;
        var posts = state.mainPosts.filter(function (v) {
          if (v.title.includes(term) || v.me.includes(term)) {
            return true;
          }
        });

        var _mainPosts2 = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(posts);
...
//# sourceMappingURL=index.js.901f14e91e2eba5ed34b.hot-update.js.map