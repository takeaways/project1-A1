...
var reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case FIX_POST:
      {
        var _action$data = action.data,
            _index = _action$data.index,
            _fixText = _action$data.fixText,
            _fixTitle = _action$data.fixTitle,
            _date = _action$data.date,
            check = _action$data.check;
        var post = state.mainPosts[_index];
    ...
    case DEL_POST:
      {
        var id = action.data;
        var _post = state.mainPosts[index];

        var _mainpost = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, _post, {
          title: fixTitle,
          text: fixText,
          date: date
        });
...
//# sourceMappingURL=index.js.b791a5c4b23d8b29e9c7.hot-update.js.map