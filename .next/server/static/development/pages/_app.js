...
const NicknameEditForm = () => {
  ...
  const [nickname, setNickname] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(me);
  ...
  const onSubmit = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(e => {
    ...
    dispatch({
      type: _reducers_post__WEBPACK_IMPORTED_MODULE_3__["SET_NICKNAME"],
      data: nickname
    });
  }, [nickname]);
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: undefined
  }, "\uC218\uC815")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    style: {
      marginTop: "50px"
    },
    __source: {
    ...
    __self: undefined
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_PostForm__WEBPACK_IMPORTED_MODULE_4__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33
    },
...
const PostForm = () => {
  ...
  const checkbox = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])(null);
  ...
  const [id, setId] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(0);
  const [check, setCheck] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(false);
  const [nickname, setNickname] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(me);
  const onChangeText = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(e => {
    setText(e.target.value);
  }, []);
  const onChangeTile = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(e => {
    setTitle(e.target.value);
  }, []);
  const onCheck = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(e => {
    setCheck(e.target.checked);
  });
  const onSubmitPost = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(e => {
    e.preventDefault();
    ...
    setId(pre => _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(pre) + 1);
...
var _jsxFileName = "C:\\Users\\USER\\projectA1Platform\\pages\\_app.js";
...
const configStore = (initialState, options) => {
  const middlewares = [];
  const enhancer =  false ? undefined : Object(redux__WEBPACK_IMPORTED_MODULE_4__["compose"])(Object(redux__WEBPACK_IMPORTED_MODULE_4__["applyMiddleware"])(...middlewares), !options.isServer && window.__REDUX_DEVTOOLS_EXTENSION__ !== 'undefined' ? window.__REDUX_DEVTOOLS_EXTENSION__() : f => f);
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_3___default()(configStore)(Main)); //고차 컴포넌트 기존 컴포넌트의 기능을 확정할 때 사용합니다.
